...
- **The download pages are a release step, not a hand edit.** `downloads/index.html`
  is the full page and `downloads/core/index.html` the Sequentia Core one; a
  release changes the product's card here and applies both with
